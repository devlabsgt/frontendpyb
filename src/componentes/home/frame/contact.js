          ...
          <div className="col-lg-6">
            <div className="d-flex flex-column gap-3">
              <a
                ...
                style={{ backgroundColor: '#009acc', color: '#fff' }}
                target="_blank"
              ...
              <a
              href="tel:+50278239999"
              className="btn btn-lg"
              style={{ backgroundColor: '#009acc', color: '#fff' }}>
                

                <i
                className="bi bi-telephone me-2"></i> +502 7823-9999
              </a>
              <a href="mailto:comunicacionguate@pazbien.org"
              className="btn btn-lg"
              style={{ backgroundColor: '#009acc', color: '#fff' }}>
              ...
              <div className="card-body">
                <div className="row text-center">
                  ...
                  <div className="col-md-6 mb-3">
                    <p className="mb-1">
                      <i className="bi bi-geo-alt-fill" style={{ fontSize: '2rem', color: '#009acc', }}></i>
                    </p>
                  ...
                  <div className="col-md-6 mb-3">
                    <p className="mb-1">
                      <i className="bi bi-clock-fill" style={{ fontSize: '2rem', color: '#009acc', }}></i>
                    </p>
